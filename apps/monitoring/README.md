# LayerRail Deploy Monitoring (Go Version)

Application that powers LayerRail Deploy's monitoring service.
...
LayerRail Deploy uses a callback URL to send notifications when metrics exceed configured thresholds. Notifications are sent via POST request in the following format:
