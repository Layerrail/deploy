import { findGitlabById, updateGitlab } from "@LayerRail Deploy/server";
...
export default async function handler(
	...
	// Use internal URL for token exchange when GitLab is on same instance as LayerRail Deploy
