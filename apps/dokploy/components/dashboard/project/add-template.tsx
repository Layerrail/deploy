...
const TEMPLATE_BASE_URL_KEY = "LayerRail Deploy_template_base_url";
								...
								{templates?.map((template, idx) => (
									...
									>
										...
										>
											...
											<img
												src={`${customBaseUrl || "https://templates.LayerRail Deploy.com/"}/blueprints/${template?.id}/${template?.logo}`}
												className={cn(
													"object-contain",
														...
														{shouldShowServerDropdown && (
															<div>
																...
																<Select
																	...
																	defaultValue={
																		!isCloud ? "LayerRail Deploy" : undefined
																	}
																>
																	<SelectTrigger>
																		<SelectValue
																			placeholder={
																				!isCloud ? "LayerRail Deploy" : "Select a Server"
																			}
																		/>
																	</SelectTrigger>
																	<SelectContent>
