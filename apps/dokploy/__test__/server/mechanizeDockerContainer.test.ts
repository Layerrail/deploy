import type { ApplicationNested } from "@LayerRail Deploy/server/utils/builders";
import { mechanizeDockerContainer } from "@LayerRail Deploy/server/utils/builders";
...
vi.mock("@LayerRail Deploy/server/utils/servers/remote-docker", () => ({
