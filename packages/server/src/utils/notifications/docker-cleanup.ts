...
import DockerCleanupEmail from "@LayerRail Deploy/server/emails/emails/docker-cleanup";
		...
		try {
			if (email || resend) {
				...
				if (email) {
					await sendEmailNotification(
						email,
						"Docker cleanup for LayerRail Deploy",
						template,
					);
				}
			...
			if (discord) {
				...
				await sendDiscordNotification(discord, {
					...
					footer: {
						text: "LayerRail Deploy Docker Cleanup Notification",
					},
				});
			}
