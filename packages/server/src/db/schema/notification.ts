...
export const notifications = pgTable("notification", {
	...
	LayerRail DeployRestart: boolean("LayerRail DeployRestart").notNull().default(false),
	LayerRail DeployBackup: boolean("LayerRail DeployBackup").notNull().default(false),
...
export const apiCreateSlack = notificationsSchema
	.pick({
		appBuildError: true,
		databaseBackup: true,
		LayerRail DeployBackup: true,
		volumeBackup: true,
		LayerRail DeployRestart: true,
		name: true,
		appDeploy: true,
		dockerCleanup: true,
...
export const apiUpdatePushover = z.object({
	...
	LayerRail DeployBackup: z.boolean().optional(),
	volumeBackup: z.boolean().optional(),
	LayerRail DeployRestart: z.boolean().optional(),
