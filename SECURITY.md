# LayerRail Deploy Security Policy

At LayerRail Deploy, security is a top priority. We appreciate the help of security researchers and the community in identifying and reporting vulnerabilities.

## How to Report a Vulnerability

If you have discovered a security vulnerability in LayerRail Deploy, we ask that you report it responsibly by following these guidelines:

1.  **Contact us:** Send an email to [contact@LayerRail Deploy.com](mailto:contact@LayerRail Deploy.com).
...
Thank you for helping us keep LayerRail Deploy secure for everyone.
